    ...
    <div>
        <div className='sidebar'>
            ...
            <h2 className='fw-bold text-center text-light'>Admin</h2>
                <Link to='/dashboard' className='sidebar-btn btn btn-danger p-5 shadow  rounded'><i class="fi fi-rr-user"></i> DashBoard</Link>
                ...
                <a href='/theatrelist' className='sidebar-btn btn btn-outline-danger p-4 shadow  rounded'><i class="fi fi-rr-features"></i> Theatres</a>
            </div>
        </div>
    </div>
  )
